...
All projects from PDF upgraded to real‑world, active defence tools.
Run with: python3 project_menu.py
"""
...
# ---- ASCII Art Headers for Each Project ----
def header(title):
    print("\n" + "="*60)
    print(f"  {title}")
    print("="*60 + "\n")
...
# ============================================================
# PROJECT FUNCTIONS (1–18 + duplicates 19–30)
# ============================================================
...
# ---- DUPLICATES FOR 19-30 (map to 05-16) ----
